 ...
 **/
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(() => {
 "use strict";
 var t=180/Math.PI;
 var e=[];
 var i=[];
 ...
 p.bezierThrough=u,p.cubicToQuadratic=o,p._autoCSS=!0,p.quadraticToCubic=(t, e, i) => new n(t,(2*e+t)/3,(2*e+i)/3,i),p._cssRegister=() => {var t=_gsScope._gsDefine.globals.CSSPlugin;if(t){
  ...
  e._registerComplexSpecialProp("bezier",{parser(t, e, n, a, o, h) {
   ...
   var d=[];
   var m={};
   if(0>c)return o;for(l=0;c>=l;l++)_=i(t,f[l],a,o,h,c!==l),d[l]=_.end;for(u in e)m[u]=e[u];return m.values=d,o=new r(t,"bezier",0,0,_.pt,2),o.data=_,o.plugin=h,o.setRatio=s,0===m.autoRotate&&(m.autoRotate=!0),!m.autoRotate||m.autoRotate instanceof Array||(l=m.autoRotate===!0?0:Number(m.autoRotate),m.autoRotate=null!=_.end.left?[["left","top","rotation",l,!1]]:null!=_.end.x?[["x","y","rotation",l,!1]]:!1),m.autoRotate&&(a._transform||a._enableTransforms(!1),_.autoRotate=a._target._gsTransform),h._onInitTween(_.proxy,m,a._tween),o
  }})
...
}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()(),(t => {"use strict";var e=() => (_gsScope.GreenSockGlobals||_gsScope)[t];"function"==typeof define&&define.amd?define(["TweenLite"],e):"undefined"!=typeof module&&module.exports&&(require("../TweenLite.js"),module.exports=e())})("BezierPlugin");