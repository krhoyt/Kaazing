...
*/
this.createjs=this.createjs||{},(() => {"use strict";var a=createjs.PreloadJS=createjs.PreloadJS||{};a.version="NEXT",a.buildDate="Wed, 02 Apr 2014 17:54:19 GMT"})(),this.createjs=this.createjs||{},(() => {
  "use strict";
  ...
  var b=a.prototype;
  var c=a;
  c.ABSOLUTE_PATT=/^(?:\w+:)?\/{2}/i,c.RELATIVE_PATT=/^[./]*?\//i,c.EXTENSION_PATT=/\/?[^/]+\.(\w{1,5})$/i,b.loaded=!1,b.canceled=!1,b.progress=0,b._item=null,b.getItem=function(){return this._item},b.init=() => {},b.load=() => {},b.close=() => {},b._sendLoadStart=function(){this._isCanceled()||this.dispatchEvent("loadstart")},b._sendProgress=function(a){if(!this._isCanceled()){var b=null;"number"==typeof a?(this.progress=a,b=new createjs.Event("progress"),b.loaded=this.progress,b.total=1):(b=a,this.progress=a.loaded/a.total,(isNaN(this.progress)||1/0==this.progress)&&(this.progress=0)),b.progress=this.progress,this.hasEventListener("progress")&&this.dispatchEvent(b)}},b._sendComplete=function(){this._isCanceled()||this.dispatchEvent("complete")},b._sendError=function(a){!this._isCanceled()&&this.hasEventListener("error")&&(null==a&&(a=new createjs.Event("error")),this.dispatchEvent(a))},b._isCanceled=function(){return null==window.createjs||this.canceled?!0:!1},b._parseURI=a => {var b={absolute:!1,relative:!1};if(null==a)return b;var d=a.indexOf("?");d>-1&&(a=a.substr(0,d));var e;return c.ABSOLUTE_PATT.test(a)?b.absolute=!0:c.RELATIVE_PATT.test(a)&&(b.relative=!0),(e=a.match(c.EXTENSION_PATT))&&(b.extension=e[1].toLowerCase()),b},b._formatQueryString=(a, b) => {if(null==a)throw new Error("You must specify data.");var c=[];for(var d in a)c.push(d+"="+escape(a[d]));return b&&(c=c.concat(b)),c.join("&")},b.buildPath=function(a,b){
    if(null==b)return a;
    var c=[];
    var d=a.indexOf("?");
